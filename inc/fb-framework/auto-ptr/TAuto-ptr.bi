#ifndef __FB_AUTO_PTR__
#define __FB_AUTO_PTR__
...
'/
#define auto_ptr( TType ) _
  __T__##Auto_ptr##__##TType##__
  ...
  type _
    ...
    public:
      declare constructor( _
        byval as __##TType ptr )
      declare constructor( _
        byref as Auto_ptr( of( TType ) ) )
      declare destructor()
      
      declare operator _
        cast() as __##TType ptr
      declare operator _
        cast() byref as __##TType
...
#macro implement_auto_ptr( TType )
  ...
  /'
    Default constructor is, of course, disabled
  '/
  constructor _
    Auto_ptr( of( TType ) )()
  end constructor
  ...
  /'
    Notice the semantics of the copy constructor: whenever an
    instance of an auto_ptr is passed to it, the current instance 
    __takes ownership__ of the pointer from the other instance. 
    ...
    delete itself but __not__ the pointer it aggregates, since its
    ownership was taken by another instance.
  '/
  constructor _
    Auto_ptr( of( TType ) )( _
      byref rhs as Auto_ptr( of( TType ) ) )
  ...
  operator _
    Auto_ptr( of( TType ) ).let( _
      byref rhs as Auto_ptr( of( TType ) ) )
  end operator
  
  operator _
    Auto_ptr( of( TType ) ).cast() _
    as TType ptr
  ...
  operator _
    ->( _
      byref rhs as Auto_ptr( of( TType ) ) ) _
    byref as TType
