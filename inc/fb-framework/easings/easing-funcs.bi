#ifndef __FB_EASINGS_FUNCS__
#define __FB_EASINGS_FUNCS__
...
namespace Easings
  ...
  function _
    ...
    if( t < 0.125 ) then
      return( sin( t * 8.0 * Pi ) * 0.0625 )
    elseif( t < 0.333 ) then
      return( sin( ( t - 0.125 ) * 4.8076 * Pi ) * 0.104 )
    elseif( t < 0.6 ) then
      return( sin( ( t - 0.333 ) * 3.7453 * Pi ) * 0.267 )
    else
      return( sin( ( t - 0.6 ) * 2.5 * HalfPi ) )
    end if
  end function
