#ifndef __FB_TEMPLATES__
#define __FB_TEMPLATES__
...
'/
#macro _
  template_type_non_keyed( TTemplate, TType... )
...
'/
#macro _
  template_type_keyed( TTemplate, TKey, TType... )
